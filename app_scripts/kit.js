...
function showPersonalizedDocsSetupAlert_() {
  SpreadsheetApp.getUi().alert(
    [
      ...
      "",
      "Most common causes:",
      "1. personalized_docs.js was not pasted into the live Apps Script project.",
      "2. An older Personalized Docs file still exists, so Apps Script is loading duplicate top-level declarations.",
      "3. The file was pasted partially and left a syntax error in the live project.",
      "",
      "Fix:",
      "1. Keep only one Personalized Docs file in Apps Script.",
      "2. Replace that file with the full latest local version.",
